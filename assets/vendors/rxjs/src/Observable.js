System.register(['./util/root', './util/toSubscriber', 'symbol-observable'], function(exports_1, context_1) {
    ...
    var root_1, toSubscriber_1, symbol_observable_1;
    var Observable;
    return {
        setters:[
            function (root_1_1) {
